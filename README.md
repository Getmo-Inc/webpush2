# Smartpush
---
## Web Push SDK Documentation 1.2.1
...
Download "Webpush Installation Files" (*.zip) from [https://cdn.getmo.com.br/webpush-pack-1.2.1.zip](https://cdn.getmo.com.br/webpush-pack-1.2.1.zip) and install the following files in the root of your website:
- webpush-1.2.1.html
...
- ``http://cdn.getmo.com.br/webpush-1.2.1.min.js``
- ``https://cdn.getmo.com.br/webpush-1.2.1.min.js``

and you are ready to go!
```html
<script src="//cdn.getmo.com.br/webpush-1.2.1.min.js"></script>
```
